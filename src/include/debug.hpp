...
static const bool asmLogging = false;
static const bool consoleLogging = false;
static const bool outputAssemblyFile = true;
...
std::string getPrintableExtern(AST::Extern* ast, int tabs = 0);
